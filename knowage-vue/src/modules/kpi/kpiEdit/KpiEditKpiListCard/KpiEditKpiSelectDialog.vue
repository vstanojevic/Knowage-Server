<template>
    <Dialog id="kpi-edit-kpi-select-dialog" class="p-fluid kn-dialog--toolbar--primary" :style="kpiEditKpiListCardDescriptor.dialog.style" :contentStyle="kpiEditKpiListCardDescriptor.dialog.contentStyle" :visible="visible" :modal="true" :closable="false">
        <template #header>
        ...
        <DataTable
            ...
            :kpiEditKpiListCardDescriptor="kpiEditKpiListCardDescriptor.selectKpiGlobalFilterFields"
