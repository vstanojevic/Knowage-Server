            ...
            <div class="p-grid">
                ...
                <div class="p-field p-col-6">
                    <span class="p-float-label">
                        ...
                        />
                        <label class="kn-material-input-label"> {{ $t('kpi.kpiEdit.precision') }}</label>
                    </span>
                </div>
                <div class="p-col-6 p-fluid">
                    <span class="p-float-label">
                        <Dropdown class="kn-material-input" v-model="options.history.units" :options="kpiEditOptionsCardDescriptor.unitsOptions" optionValue="value">
                        ...
                        <label class="kn-material-input-label"> {{ $t('kpi.kpiEdit.units') }} </label>
                    </span>
                </div>
            </div>
        </template>
