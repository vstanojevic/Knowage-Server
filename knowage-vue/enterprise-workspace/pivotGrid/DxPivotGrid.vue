...
<script lang="ts">
import { emitter } from '../../src/modules/documentExecution/dashboard/DashboardHelpers'
import { IDataset, ISelection, IWidget, ITableWidgetColumnStyles, ITableWidgetConditionalStyles, ITableWidgetVisualizationTypes } from '../../src/modules/documentExecution/dashboard/Dashboard'
import { defineComponent, PropType } from 'vue'
import mainStore from '../../src/App.store'
import dashboardStore from '../../src/modules/documentExecution/dashboard/Dashboard.store'
import { getColumnConditionalStyles, getWidgetStyleByType, stringifyStyleProperties } from '../../src/modules/documentExecution/dashboard/widget/TableWidget/TableWidgetHelper'
import { IPivotTooltips } from '../../src/modules/documentExecution/dashboard/interfaces/pivotTable/DashboardPivotTableWidget'
import { getFormattedClickedValueForCrossNavigation, createPivotTableSelection } from '../../src/modules/documentExecution/dashboard/widget/PivotWidget/PivotWidgetHelpers'
import { updateAllStoreSelections, executePivotTableWidgetCrossNavigation } from '../../src/modules/documentExecution/dashboard/widget/interactionsHelpers/InteractionHelper'
import { mapActions } from 'pinia'
import { formatNumberWithLocale } from '../../src/helpers/commons/localeHelper'
